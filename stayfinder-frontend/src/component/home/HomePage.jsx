...
import hotelPic from "../../assets/images/hotel.webp"
        ...
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    <img src={hotelPic}  alt="Stay Finder" className="header-image" />
            ...
            <section className="service-section"><div className="service-card">
                <img src={acPic} alt="Air Conditioning" />
